...
import static org.goat.util.CurrencyConverter.*;
...
public class User {
    ...
    public synchronized void setLastMessage(Message m) {
        lastTimestamps.save(m.getChatname(), System.currentTimeMillis());
        strStore.save(LASTMESSAGE,m.getText());
        strStore.save(LASTCHANNEL,m.getChatname());
    }
