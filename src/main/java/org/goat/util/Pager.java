...
public class Pager {
    ...
    private static int defaultMaxBytes = 4096; //on telegram, max is 4096 *characters* tho
    ...
    private final String inputExceededMsg = " " + BOLD + "[" + END_BOLD + "no more \u2014 buffer protection engaged" + BOLD + "]" + END_BOLD;
