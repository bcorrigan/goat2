...
public abstract class Module implements Runnable {
    ...
    /* no doubt mapdb is revolutionised by now
    ...
    */
    ...
    public void processMessage(Message m) {
        try {
            ...
            e.printStackTrace();
            m.reply( this.getClass().getSimpleName() + " caused an exception: "
                    + e.getLocalizedMessage() + ". You will probably want to fix this.");
        }
    ...
    public synchronized void stopDispatcher() {
        ...
        //incomingQueue.add(new Message()); can't construct this so easily in 2024
    }
